...
maps[""]["<Left>"] = "<Nop>"
maps[""]["<Right>"] = "<Nop>"
maps[""]["<A-z>"] = {"<cmd>set wrap<cr>", desc="Word Wrap"}
maps[""]["<A-S-z>"] = {"<cmd>set wrap! <cr>", desc="Word Wrap"}
...
maps.n["<C-t>"] = { "<cmd>enew<cr>", desc = "New File" }
...
if is_available "telescope.nvim" then
  ...
  maps.n["<C-f>"] = { function() require("telescope.builtin").find_files() end, desc = "Search files" }
  maps.n["<leader>ff"] = {
